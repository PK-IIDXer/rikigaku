...
\section{積分の単調性と三角不等式}

関数の大小関係によって、積分結果の大小関係が保存されます。
これは積分の\textbf{単調性}と呼ばれます。
\begin{theorem}
...
積分に関する大小関係の保存則から、積分に関する\textbf{三角不等式}と呼ばれる以下の定理が導かれます。
\begin{corollary}
  $[a,b]$を区間、$f:[a,b]\to\mathbb{R}$を連続関数とする。
  このとき
  \[
